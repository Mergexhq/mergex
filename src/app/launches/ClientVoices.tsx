...
export default function ClientVoices() {
  return (
    <section className="relative w-full bg-black py-24 md:py-32 overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10 flex flex-col gap-16">
        {/* Header */}
        <div className="flex flex-col gap-4 max-w-2xl">
          ...
          <h2
            className="font-questrial font-bold text-white leading-none"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[600px] overflow-hidden relative w-full mask-y">
...
function TestimonialCard({ item }: { item: Testimonial }) {
  return (
    <div className="bg-[#0b0b0b] border border-white/8 rounded-2xl p-6 md:p-8 flex flex-col justify-between gap-6 transition-all duration-300 hover:border-white/20 select-none cursor-grab active:cursor-grabbing">
