...
export default function FooterCurtain() {
    ...
    return (
        <div
            className="bg-black pt-20 pb-4 lg:pb-10 relative w-full min-h-[40vh] flex flex-col justify-end"
        ...
        >
            ...
            <div className="absolute inset-0 z-0 pointer-events-none lg:hidden">
                <img
                    src="/background/footer/footer_mobile.webp"
            ...
            <div className="w-full relative" style={{ zIndex: 10, overflow: 'visible' }}>
                <div className="max-w-[100vw] mx-auto px-6 md:px-10 relative" style={{ zIndex: 20 }}>
                    <div className="flex flex-col items-center justify-end pb-4 md:pb-8">
                        <div className="relative text-center w-full">
                            <div className="flex flex-row items-baseline justify-center whitespace-nowrap w-full relative" style={{ zIndex: 10 }}>
                                <div className="relative inline-block">
                                    {/* "THE" label top-left */}
                                    <div className="absolute top-[1%] md:top-[2%] left-[1.5%] md:left-[1vw] text-left" style={{ zIndex: 20 }}>
                                        <span className="text-[3vw] md:text-[1.1vw] font-bold text-white uppercase tracking-[0.7em] select-none font-clash">
                                            THE
                                        </span>
                                    </div>

                                    {/* Main MERGEX heading */}
                                    <h2 className="text-[20vw] leading-none font-bold text-white tracking-widest select-none font-clash uppercase relative text-center" style={{ zIndex: 10, overflow: 'visible' }}>
                                        MERGEX
                                    </h2>

                                    {/* "COMPANY" label bottom-right */}
                                    <div className="absolute bottom-[-1%] md:bottom-[-1.5%] right-[3%] md:right-[2.5vw] text-right" style={{ zIndex: 20 }}>
                                        <span className="text-[4vw] md:text-[1.6vw] font-bold text-white uppercase tracking-[0.6em] select-none font-clash" style={{ marginRight: '-0.6em' }}>
                                            COMPANY
                                        </span>
                                    </div>
                                </div>
