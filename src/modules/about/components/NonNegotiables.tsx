...
export function NonNegotiables() {
  ...
  useEffect(() => {
    ...
    const rows = sectionRef.current?.querySelectorAll('.standard-row');
    rows?.forEach((el, i) => {
    ...
    <section ref={sectionRef} className="about-standards">
      <div className="standards-inner">
        ...
        <div className="standards-left">
          <div className="standards-heading">Section 03</div>
          <h2 className="standards-title">How we<br />work.</h2>
