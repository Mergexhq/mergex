    ...
    return (
        <section className="methodology-hero">
            ...
            <div className="methodology-hero-inner">
                <div>
                    <p className="methodology-hero-tag">Our Consulting Method</p>
                ...
                <div className="methodology-hero-right">
                    <p className="methodology-hero-para">
                        Most businesses approach growth by hiring more, spending more,
                        and trying more. The problem is never effort. It is always{' '}
                        <strong>what gets diagnosed</strong>.
                    </p>
                    <p className="methodology-hero-para">
